...
describe("generateCompletion — fish", () => {
  ...
  it("offers top-level command names only before a subcommand is present", () => {
  ...
  it("emits long options with -l and short options with -s, once the command is seen", () => {
  ...
  it("offers a parent command's subcommand names until one is chosen", () => {
    ...
    // per-subcommand flags, gated on that subcommand being seen
