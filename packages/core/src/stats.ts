 ...
 * can show which days rate-limits tend to cluster on ("I mostly get throttled on
 * Mondays"). Like {@link computeHourlyDistribution} and unlike
 * {@link computeDailyTrend} this has no window and needs no clock: day-of-week is
 * an absolute property of each timestamp.
 *
 * The result is always exactly 7 entries, weekday 0 (Sunday) through weekday 6
