...
export interface WeekdayActivity {
  /** UTC day of week, 0–6 where 0 = Sunday (matches `Date.getUTCDay()`). */
  weekday: number;
 ...
 * get throttled on weekdays, quiet on the weekend"). Like
 * {@link computeHourlyDistribution} and unlike {@link computeDailyTrend} this
 * has no window and needs no clock: day-of-week is an absolute property of each
 * timestamp.
 *
