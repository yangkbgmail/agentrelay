...
const PATTERNS: RateLimitPattern[] = [
  ...
  },
  {
    ...
    // "try again in 2 days" / "resets in 1d 4h" / "try again in 1 week" / "resets in 2w 3d" —
    // week and day groups cover Claude's weekly usage windows (which reset up to a
    // full week out and are sometimes phrased literally as "1 week", not "7 days").
