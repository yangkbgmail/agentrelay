...
describe("computeHourlyDistribution", () => {
  it("returns exactly 24 slots, hour 0 first, zero-filled for an empty store", () => {
  ...
  it("buckets jobs by their UTC hour-of-day, aggregating across all days", () => {
    const jobs = [
      job({ createdAt: "2026-07-20T09:15:00.000Z" }),
      job({ createdAt: "2026-07-19T09:45:00.000Z" }), // same hour, different day → same bucket
