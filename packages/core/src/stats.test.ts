...
describe("computeHourlyDistribution", () => {
  it("always returns 24 slots, hour 0 first, zero-filled for an empty list", () => {
  ...
  it("buckets jobs by their UTC hour of creation, collapsing all days", () => {
    const jobs = [
      job({ createdAt: "2026-07-20T09:15:00.000Z" }),
      job({ createdAt: "2026-07-19T09:45:59.000Z" }), // same hour, different day → same bucket
  ...
  it("places midnight and end-of-day boundaries in hours 0 and 23", () => {
