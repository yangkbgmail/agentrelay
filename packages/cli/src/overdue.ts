 ...
 * (matching the shape of `status`/`upcoming --watch`) plus the colored overdue
 ...
 * rebuilds the report with a fresh `now` each pass — the ideal shape for a
 * stuck-resume-loop monitor left running in a spare terminal.
 */
