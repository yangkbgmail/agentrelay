 ...
 * this. The "overdue by" spans grow in place because the loop re-reads the store
 * and rebuilds the report with a fresh `now` each pass — a stuck resume loop is
 * exactly what you'd sit and watch here.
 */
