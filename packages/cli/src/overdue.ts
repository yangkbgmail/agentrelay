 ...
 * the shape of `status --watch` and `upcoming --watch`) plus the colored table.
 ...
 * rebuilds the report with a fresh `now` each pass — the diagnostic mirror of
 * the upcoming countdowns ticking *down*.
 */
