...
export function buildCli(): Command {
  ...
  program
    ...
    .option("--by-hour", "Also show a UTC hour-of-day activity histogram (00–23, collapsed across all days)")
    ...
    .action(
      (opts: {
        ...
        const hourly = opts.byHour ? computeHourlyActivity(jobs) : null;
        ...
        if (hourly !== null && stats.total > 0) {
          console.log("");
          console.log(renderHourlyActivity(hourly, { color: Boolean(process.stdout.isTTY) }));
        }
      }
    );
