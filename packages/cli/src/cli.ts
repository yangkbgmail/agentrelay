  ...
  startWatchLoop(intervalMs, () => {
    ...
    if (groupBy !== undefined) {
      ...
      if (heatmap && stats.total > 0) {
        body += `\n\n${renderHeatmap(computeWeekdayHourHeatmap(jobs), { color: true })}`;
      }
    }
...
export function buildCli(): Command {
  ...
  program
    ...
    .option("--heatmap", "Also show a weekday × hour (UTC) activity heatmap (the 2-D join of --weekday and --hours)")
    ...
    .addHelpText(
      ...
      "\nExamples:\n" +
        ...
        "  # which weekday-and-hour combinations rate-limits cluster in\n" +
    ...
    .action(
      (opts: {
        ...
        const heatmap = opts.heatmap ? computeWeekdayHourHeatmap(jobs) : null;
