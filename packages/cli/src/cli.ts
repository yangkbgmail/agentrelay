...
export function buildCli(): Command {
  ...
  program
    .command("completion")
    .description("Print a shell completion script for agentrelay (bash, zsh, or nushell)")
    ...
    .addHelpText(
      ...
      "\nExamples:\n" +
        ...
        "  # nushell: save it and source it from your config.nu\n" +
        "  agentrelay completion nushell > ~/.agentrelay.nu"
    )
    .action((shell: string) => {
