...
export function buildCli(): Command {
  ...
  program
    ...
    .option("--hourly", "Also show a UTC hour-of-day activity histogram (which hours rate-limits pile up)")
    ...
    .action(
      (opts: {
        ...
        const hourly = opts.hourly ? computeHourlyDistribution(jobs) : null;
