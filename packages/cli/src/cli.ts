...
export function buildCli(): Command {
  ...
  config
    .command("init")
    .description("Write a starter agentrelay.config.json (with default values) you can edit")
    .option("-p, --path <path>", "Where to write the file (default: ./agentrelay.config.json)")
