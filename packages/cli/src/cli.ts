...
export function buildCli(): Command {
  ...
  program
    ...
    .option("--hours", "Also show an hour-of-day activity histogram (jobs created per UTC hour, all days collapsed)")
    ...
    .action(
      (opts: {
        ...
        const hourly = opts.hours ? computeHourlyDistribution(jobs) : null;
