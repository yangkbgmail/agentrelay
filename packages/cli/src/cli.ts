...
export function buildCli(): Command {
  ...
  program
    ...
    .option("--by-hour", "Also show a per-hour-of-day activity histogram (0–23, UTC) across all days")
    ...
    .action(
      (opts: {
        ...
        const hourly = opts.byHour ? computeHourlyTrend(jobs) : null;
        ...
        // Append the histogram(s) only when the store has matching jobs
