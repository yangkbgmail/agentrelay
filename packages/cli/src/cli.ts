  ...
  program
    ...
    .action(
      (opts: {
        ...
        // --columns picks/reorders the tabular columns; only COLUMN_AWARE_FORMATS
        // (csv/tsv/md/html) honor it. json/ndjson are lossless full-shape, so a
        // --columns there is a mistake we surface rather than silently ignore.
