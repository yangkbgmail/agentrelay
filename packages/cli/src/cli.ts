 ...
 * JSON store each pass (so a daemon catching up makes stuck jobs disappear) and
 * the `--grace`/`--tool`/`--project`/`--since`/`--until` scope plus `--limit` are
  ...
  program
    ...
    .addHelpText(
      ...
      "\nExamples:\n" +
        ...
        "\n  # keep watching until it clears (live spans growing)\n" +
