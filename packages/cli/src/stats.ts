 ...
 * Mon–Sun, aggregated across all weeks) as a compact ASCII bar chart. Bars scale
 * to the busiest weekday so the shape reads regardless of absolute volume; a zero
