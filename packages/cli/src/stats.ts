...
/** Max width (chars) of a full-scale bar in the weekday histogram. */
...
/**
 * Renders a day-of-week activity histogram (jobs created per UTC weekday, Sunday
 * through Saturday, aggregated across all weeks) as a compact ASCII bar chart.
