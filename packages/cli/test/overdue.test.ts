...
describe("renderOverdueWatchFrame", () => {
  ...
  it("embeds the colored overdue table body", () => {
    const out = renderOverdueWatchFrame(report([job()]), "/tmp/jobs.json", 2000, NOW);
    // 90m overdue span comes from the report, formatted by stats.
